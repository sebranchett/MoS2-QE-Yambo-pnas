...
# SEB TODO
# SEB KfnQPdb= "E < GW_QP_database/ndb.QP"              # [EXTQP BSK BSS] Database
# SEB KfnQP_INTERP_NN= 1                   # [EXTQP BSK BSS] Interpolation neighbours
# SEB  % KfnQP_E
# SEB    0.000000 | 1.000000 | 1.000000 |        # [EXTQP BSK BSS] E parameters  (c/v) eV|adim|adim
# SEB %
# and run
